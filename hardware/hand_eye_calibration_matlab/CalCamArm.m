...
%
%   armMat- nx4x4 set of arm transformation matrices that give the
...
numBoot = 100;
cameraParams = [];
%cameraParams.IntrinsicMatrix = [[976.405945, 0, 1020.967651]; [0, 976.266479, 779.519653]; [0, 0, 1]];
%cameraParams.TangentialDistortion = [-2.77779, -0.000323];
%cameraParams.RadialDistortion = [0.513059, 0.000703, 1.62693];

%baseEst = eye(4);
baseEst = [ 0.02484655,-0.92991847,0.36692545,-1.0373739; -0.99899, -0.03684178,-0.02572293,-0.04571882; 0.03743841,-0.36591572,-0.92989464 ,1.09478031;0,0,0,1];
endEst = eye(4);
saveImages = true;
savePath = 'output';
